...
$(BUILD)/tr_tessellator: $(BUILD)/tr_tessellator.o
	$(CXX) $(CFLAGS) -o $(BUILD)/tr_tessellator $(BUILD)/tr_tessellator.o $(LINKGRO) $(LIBGRO)

install: $(BUILD)/tr_tessellator
	install $(BUILD)/tr_tessellator $(INSTALL)

$(BUILD)/tr_tessellator.o: $(SRC)/tr_tessellator.c
	$(CC) $(CFLAGS) -o $(BUILD)/tr_tessellator.o -c $(SRC)/tr_tessellator.c $(DEFV5) $(INCGRO)
